...
use said::{derivation::{HashFunction, HashFunctionCode}, sad::DerivationCode};
use thiserror::Error;
...
fn test_json_to_sad() {
	...
	let expected_said  = HashFunction::from(HashFunctionCode::Blake3_256).derive(to_compute.as_bytes());
