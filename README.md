...
THIS REPO IS ARCHIEVED, it was done for demo purpose only. If you are interested in components which are in used here take a look in [DKMS Colossi Network](https://dkms.colossi.network/).
